...
namespace Kratos {
  ...
  void test_app2() {
    ...
    std::cout << "APP2: I can aceess own functions:\t" << app2_function() << std::endl;
    std::cout << "APP2: I can access shared variables:\t" << APP1_INT << std::endl;
    std::cout << "APP2: I can aceess shared functions:\t" << app1_function() << std::endl;
    std::cout << "APP2: I can access core variables:\t" << CORE_INT << std::endl;
    std::cout << "APP2: I can aceess core functions:\t" << core_function() << std::endl;
  }
